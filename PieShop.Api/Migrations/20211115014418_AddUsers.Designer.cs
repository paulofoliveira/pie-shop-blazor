...
namespace PieShop.Api.Migrations
{
    ...
    [Migration("20211115014418_AddUsers")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PieShop.Api.Infrastructure.Data.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            Email = "paulo.fdo@hotmail.com",
                            Enabled = true,
                            Password = "$2a$11$Xh7eNzJb9xSxk46Jl73cVOfO7qA8pzvz0uqhaUp8rSb/s4XcDnhNm"
                        });
                });

            modelBuilder.Entity("PieShop.Shared.Country", b =>
                {
            ...
            modelBuilder.Entity("PieShop.Shared.Employee", b =>
                {
            ...
            modelBuilder.Entity("PieShop.Shared.JobCategory", b =>
                {
                    b.Property<int>("JobCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PieShop.Shared.Employee", b =>
                {
                    b.HasOne("PieShop.Shared.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PieShop.Shared.JobCategory", "JobCategory")
                        .WithMany()
